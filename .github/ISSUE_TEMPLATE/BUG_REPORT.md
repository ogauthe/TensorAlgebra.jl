---
name: TensorAlgebra.jl bug report
about: Create a bug report to help us improve TensorAlgebra.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("TensorAlgebra")`:
```julia
julia> using Pkg; Pkg.status("TensorAlgebra")
[YOUR OUTPUT HERE]
```
